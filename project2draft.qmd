...
The AIC of model 3 is observed to increase following the removal of the variable harvested, as opposed to the expected decrease. Consequently, model 2 is deemed to be the most suitable, even though the variable harvested shows a p-value greater than 0.05.
